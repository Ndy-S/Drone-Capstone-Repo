...
import com.example.dropdone.ui.components.main.DetailBookingContent
    ...
    ModalNavigationDrawer(
        ...
        content = {
            Column(
                ...
                DetailBookingContent(bookingId = bookingId, client = client, userData = userData, navController = navController)
            }
        }
    )
}